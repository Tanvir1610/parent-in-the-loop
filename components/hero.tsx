  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, #B9A6E3 0%, transparent 70%)", transform: "translate(30%, -30%)" }}
        aria-hidden="true"
      />
      <div
        className="absolute bottom-0 left-0 w-80 h-80 rounded-full opacity-15 pointer-events-none"
        style={{ background: "radial-gradient(circle, #F3A78E 0%, transparent 70%)", transform: "translate(-30%, 30%)" }}
        aria-hidden="true"
      />
      <div
      ...
      <div className="max-w-2xl mx-auto text-center space-y-8 relative z-10">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          {/* Emoji icon row - brand guide specifies line art / hand-drawn emojis */}
        ...
        {/* Mission paragraph — warm, plain-spoken for parents */}
        <p
        ...
        >
          ...
          elementary and middle school kids — building curiosity, critical thinking, and
          ethical awareness in a joyful, screen-friendly way.
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <button
            className="px-8 py-3.5 font-bold rounded-xl transition-all duration-200 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-md hover:shadow-lg"
            style={{
              backgroundColor: "#F3A78E",
              color: "#fff",
              fontFamily: "var(--font-nunito), Nunito, sans-serif",
              focusRingColor: "#7C63B8",
            }}
          ...
          <button
            className="px-8 py-3.5 font-bold rounded-xl border-2 transition-all duration-200 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2"
            style={{
              borderColor: "#B79D84",
              color: "#3E3E3E",
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLButtonElement).style.borderColor = "#B79D84"
        ...
        {/* Social proof — calm, evidence-led tone */}
