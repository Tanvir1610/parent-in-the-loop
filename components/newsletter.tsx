  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        <h2 className="text-4xl font-bold text-white mb-3" style={{ fontFamily: "var(--font-quicksand), Quicksand, sans-serif" }}>
          Get Weekly AI Wisdom
        </h2>
        <p className="text-lg leading-relaxed mb-2" style={{ color: "rgba(255,255,255,0.9)", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
          Join parents building AI curiosity and critical thinking in their kids. Weekly essays, conversation starters, and hands-on activities.
        </p>
        <p className="text-sm mb-8" style={{ color: "rgba(255,255,255,0.75)", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
        ...
        {formState === "success" && (
          <div className="rounded-2xl p-8 mb-6" style={{ backgroundColor: "rgba(255,255,255,0.2)", border: "1px solid rgba(255,255,255,0.3)" }}>
            <div className="text-4xl mb-3" aria-live="polite">🎉</div>
            ...
            <p style={{ color: "rgba(255,255,255,0.9)", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
              Welcome to the Parent in the Loop community. Your first weekly AI wisdom arrives next week. ✨
            </p>
          </div>
        )}

        {formState === "duplicate" && (
          <div className="rounded-2xl p-6 mb-6" style={{ backgroundColor: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.25)" }} role="alert">
            <p className="text-white font-semibold" style={{ fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
              💌 You&apos;re already subscribed! Check your inbox — we send new content every week.
            </p>
          </div>
        )}
          ...
          <form onSubmit={handleSubmit} className="w-full" noValidate aria-label="Email subscription form">
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              <button
                ...
                onMouseEnter={(e) => { if (formState !== "loading") (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#E89175" }}
            ...
            {formState === "error" && errorMsg && (
              <p id="subscribe-error" className="mt-3 text-sm font-semibold" style={{ color: "rgba(255,255,255,0.95)" }} role="alert">
                ⚠️ {errorMsg}
              </p>
            )}
          </form>
        ...
        <div className="mt-8 border-t pt-8" style={{ borderColor: "rgba(255,255,255,0.2)" }}>
          <p className="text-xs mb-3" style={{ color: "rgba(255,255,255,0.6)", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
            Or subscribe directly via Substack:
          </p>
          <iframe
        ...
        <p className="text-xs mt-5" style={{ color: "rgba(255,255,255,0.55)", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
          Unsubscribe anytime. We never share your email. Privacy-first. 🔒
        </p>
      </div>
    </section>
  )
