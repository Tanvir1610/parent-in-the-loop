    ...
    >
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10 reveal">
        ...
        {formState === "pending_verification" && (
          <div
            className="flex flex-col items-center gap-3 py-6 text-center reveal"
            aria-live="polite"
          >
            ...
            <div>
              ...
              >
                We sent a verification link to <strong style={{ color: "#7C63B8" }}>{email}</strong>.<br/>
              ...
              <p
                ...
                style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}
              >
                Didn&apos;t receive it? Check your spam folder. The link expires in 48 hours.
              </p>
            </div>
          </div>
        )}
