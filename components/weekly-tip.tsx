...
function LockedTip() {
  return (
    <section
      ...
      aria-label="Weekly tip — sign in to unlock"
    >
      <div className="max-w-3xl mx-auto reveal">
        ...
        <div className="rounded-3xl overflow-hidden"
          ...
          <div className="px-8 pt-8 pb-4 relative"
            style={{ background: "linear-gradient(135deg, #FAF6F0 0%, rgba(185,166,227,0.12) 100%)" }}>
            <div className="flex items-start gap-5 mb-4" style={{ filter: "blur(5px)", userSelect: "none", pointerEvents: "none" }} aria-hidden="true">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl flex-shrink-0"
                style={{ backgroundColor: "rgba(124,99,184,0.1)" }}>🤖</div>
              <div className="flex-1">
                <div className="h-5 rounded-full w-24 mb-3" style={{ backgroundColor: "rgba(124,99,184,0.15)" }} />
                <div className="space-y-2">
                  <div className="h-4 rounded-full" style={{ backgroundColor: "#EDE8E1" }} />
                  <div className="h-4 rounded-full w-4/5" style={{ backgroundColor: "#EDE8E1" }} />
                  <div className="h-4 rounded-full w-3/5" style={{ backgroundColor: "#EDE8E1" }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="px-8 py-6 text-center"
            ...
            <h3 className="font-bold text-lg mb-1" style={{ color: "#222222", fontFamily: "var(--font-quicksand), Quicksand, sans-serif" }}>
              Members only content
            </h3>
            <p className="text-sm mb-5 max-w-sm mx-auto" style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
              Sign in or create a free account to unlock this week&apos;s family AI tip and all future ones.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/sign-up"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold text-sm text-white transition-all hover:scale-105 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C63B8]"
                style={{ backgroundColor: "#7C63B8", fontFamily: "var(--font-nunito), Nunito, sans-serif", boxShadow: "0 4px 14px rgba(124,99,184,0.3)" }}>
                🔓 Join Free — Unlock Now
              </Link>
              <Link href="/sign-in"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm transition-all hover:scale-105 border-2"
        ...
        <p className="text-center text-xs mt-4" style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
          Free forever · Tips rotate weekly · <span style={{ color: "#B9A6E3" }}>#ParentInTheLoop</span>
        </p>
      </div>
    </section>
  )
