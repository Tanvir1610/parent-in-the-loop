        ...
        <div className="rounded-3xl p-8" style={{ backgroundColor: "#fff", boxShadow: "0 4px 32px rgba(0,0,0,0.08)", border: "1.5px solid #EDE8E1" }}>
          {sent ? (
            <div className="text-center">
              ...
              <h1 className="text-xl font-bold mb-2" style={{ color: "#222222", fontFamily: "var(--font-quicksand), Quicksand, sans-serif" }}>Check your inbox</h1>
              <p className="text-sm mb-6" style={{ color: "#3E3E3E", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
                We sent a password reset link to <strong>{email}</strong>. Check your spam folder if you don&apos;t see it.
              </p>
              <Link href="/login" className="text-sm font-bold underline" style={{ color: "#7C63B8" }}>Back to Sign In</Link>
            </div>
          ) : (
            <>
              <h1 className="text-2xl font-bold mb-1" style={{ color: "#222222", fontFamily: "var(--font-quicksand), Quicksand, sans-serif" }}>Reset password</h1>
              <p className="text-sm mb-6" style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>Enter your email and we&apos;ll send a reset link</p>
              {error && (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                <div>
                  <label htmlFor="fp-email" className="block text-xs font-bold mb-1.5" style={{ color: "#3E3E3E", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>Email address</label>
              ...
              <p className="text-center text-sm mt-5" style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
                <Link href="/login" className="font-bold hover:underline" style={{ color: "#7C63B8" }}>← Back to Sign In</Link>
              </p>
            </>
          )}
        </div>
