...
export default function LoginPage() {
  ...
  // Show error from redirect (e.g. expired confirmation link)
  useEffect(() => {
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="rounded-3xl p-8" style={{ backgroundColor: "#fff", boxShadow: "0 4px 32px rgba(0,0,0,0.08)", border: "1.5px solid #EDE8E1" }}>
          ...
          <p className="text-sm mb-6" style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
            Sign in to access your Parent in the Loop account
          </p>
          ...
          <form onSubmit={handleLogin} noValidate className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                disabled={loading}
                className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C63B8] disabled:opacity-60 transition-all"
          ...
          <p className="text-center text-sm mt-5" style={{ color: "#B79D84", fontFamily: "var(--font-nunito), Nunito, sans-serif" }}>
            ...
            <Link href="/signup" className="font-bold hover:underline" style={{ color: "#7C63B8" }}>
              Sign up free
            </Link>
          </p>
        </div>
